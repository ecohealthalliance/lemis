...
lemis_metadata_ <- dplyr::tribble(
  ...
  "control_number", "ID number",
  "taxa", "An EHA-derived broad taxonomic categorization",
  "species_code", "USFWS code for the species",
  "genus", "Genus of the wildlife product",
  "species", "Species of the wildlife product",
  "subspecies", "Subspecies of the wildlife product",
  "specific_name", "A species-specific common name",
  "generic_name", "A general common name",
  "description", "Type/form of wildlife product (see lemis_codes())",
  "quantity", "Numeric quantity of the shipment",
  "unit", "Unit for the numeric quantity (see lemis_codes())",
  "value", "Reported value in US dollars",
  "country_origin", "ISO2C code for the country of origin of the product (see lemis_codes())",
  "country_imp_exp", "ISO2C code for the country to/from which the product is shipped (see lemis_codes())",
  "purpose", "The reason the producted is being imported (see lemis_codes())",
  ...
  "disposition_year", "Year when disposition occurred",
  "shipment_date", "Full date when the shipment arrived",
  "shipment_year", "Year when the shipment arrived",
