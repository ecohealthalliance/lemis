...
lemis_metadata_ <- dplyr::tribble(
  ...
  "taxa", "A broad taxonomic categorization",
  "class", "An EHA-derived class-level taxonomic designation",
  ...
  "country_origin", "ISO2C code for the country of origin of the wildlife product (see lemis_codes())",
  "country_imp_exp", "ISO2C code for the country to/from which the wildlife product is shipped (see lemis_codes())",
