...
The **lemis** package provides access to United States Fish and Wildlife Service (USFWS) data on wildlife and wildlife product imports to the U.S. This data was obtained via more than 14 years of Freedom of Information Act (FOIA) requests by EcoHealth Alliance.
...
The main function in **lemis** is `lemis_data()`. This returns the cleaned LEMIS database as a **dplyr** tibble.
