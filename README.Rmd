...
A preprint describes the data used in this package in detail: [United States wildlife and wildlife product imports from 2000-2014](https://doi.org/10.1101/780197). In addition, our [paper (Smith et al. 2017)](https://doi.org/10.1007/s10393-017-1211-7) provides a broad introduction to the LEMIS data and its relevance to infectious disease research specifically.

Both the raw LEMIS data and the final, cleaned dataset accessed with this package are available via a Zeonodo data repository: [United States LEMIS wildlife trade data curated by EcoHealth Alliance](https://doi.org/10.5281/zenodo.3387661). 
...
See the data paper [preprint](https://doi.org/10.1101/780197) for a more in-depth description and example use cases for the package data.
